...
public class Input extends TagImpl {
   ...
   /**
    ...
    public void setDir(String dir) {
    	...
    	//else throw engine.getExceptionUtil().createApplicationException("attribute dir for tag input has an invalid value ["+dir+"], valid values are [ltr, rtl]");
    }
    ...
    public void setDataformatas(String dataformatas) {
    	...
    	//else throw engine.getExceptionUtil().createApplicationException("attribute dataformatas for tag input has an invalid value ["+dataformatas+"], valid values are [plaintext, html");
    }
    ...
    public void setMonthnames(String listMonthNames) throws PageException {
    	...
    	if(arr.length==12)
    		throw engine.getExceptionUtil().createApplicationException("value of attribute [MonthNames] must contain a string list with 12 values, now there are "+arr.length+" values");
    	this.monthnames=arr;
    }
    ...
    public void setType(String type) throws PageException {    	
        ...
        else throw engine.getExceptionUtil().createApplicationException("attribute type has an invalid value ["+type+"]","valid values for attribute type are " +
