...
public final class Slider extends TagImpl {
    ...
    public void setAlign(String align) throws PageException {
        ...
        if(engine.getListUtil().find("top,left,bottom,baseline,texttop,absbottom,middle,absmiddle,right",align,",")>-1) {
            ...
            throw engine.getExceptionUtil().createApplicationException("attribute align ["+align+"] is invalid","valid alignments are [top,left,bottom,baseline,texttop,absbottom,middle,absmiddle,right]");
    }
    ...
    public void setLookandfeel(String lookandfeel) throws PageException {
        ...
        else throw engine.getExceptionUtil().createApplicationException("value of attribute lookAndFeel ["+lookandfeel+"] is invalid","valid values are [motif,windows,metal]");
    ...
    private void _doStartTag() throws PageException, IOException  {
        ...
        if(!Util.isEmpty(codebase=form.getCodebase()))
