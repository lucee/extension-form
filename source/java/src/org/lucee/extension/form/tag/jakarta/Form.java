...
public final class Form extends BodyTagImpl {
	...
	public void setEnablecab(boolean enablecab) {
		// throw engine.getExceptionUtil().createApplicationException("attribute Enablecab is deprecated and
		// no longer supported");
	...
	public void setMethod(String method) throws PageException {
		...
		if (method.equals("get") || method.equals("post")) this.method = method;
				...
				.createApplicationException("invalid value for attribute method from tag form, attribute can have value [get,post] but now is [" + method + "]");
	}
	...
	private void checkName(String name) throws PageException {
		...
		for (int pos = 0; pos < len; pos++) {
			...
			throw engine.getExceptionUtil()
					.createApplicationException("value of attribute name [" + name + "] is invalid, only the following characters are allowed [a-z,A-Z,0-9,-,_,:,.]");
		}
	}
