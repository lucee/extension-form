...
public final class InputBean {
    ...
    public void setPattern(String pattern) throws PageException {
    	...
    	if(pattern.startsWith("'")) {
    		if(!pattern.endsWith("'"))
    			throw engine.getExceptionUtil().createExpressionException("invalid pattern definition ["+pattern+", missing closing [']");
    	...
    	if(!pattern.startsWith("/"))	pattern="/".concat(pattern);
